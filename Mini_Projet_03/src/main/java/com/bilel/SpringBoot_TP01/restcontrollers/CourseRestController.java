...
public class CourseRestController {
	...
	Course updateCourse(@RequestBody Course course, @PathVariable("courseId") Long courseId, @RequestParam("teacher") Long teacherId, @RequestParam("speciality") Long specialityId) {
		Teacher teacher = this.teacherService.getTeacher(teacherId);
		Speciality speciality = this.specialityService.getSpecialityById(specialityId);
